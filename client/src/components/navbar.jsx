...
const Navbar = () => {
    return (
        <>
            <div className="h-[10vh] w-[90vw] bg-[#2f27ce] rounded-lg flex flex-row gap-10  backdrop-filter backdrop-blur-sm bg-opacity-10 border border-gray-100">
                <div className="w-[55vw] text-5xl  font-extrabold font-kaushan text-transparent bg-clip-text bg-gradient-to-r from-red-900 via-pink-200 to-purple-400 rounded-l-lg flex flex-col items-center justify-center"> GAMESURF </div>
